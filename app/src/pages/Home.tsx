    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-gray-950 via-black to-gray-900 flex flex-col items-center justify-center pt-20 pb-10">
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl animate-blob" style={{ animationDelay: '4s' }}></div>
        </div>
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-7xl">
          {/* Main Heading dengan Split Animation */}
          ...
          {/* CTA Buttons dengan Enhanced Hover */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20 animate-fadeIn" style={{ animationDelay: '0.8s' }}>
            <button className="group relative px-8 py-4 bg-gradient-to-r from-[#d90429] to-[#ef233c] text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/50 hover:scale-105 hover:-translate-y-1 flex items-center justify-center gap-2">
            ...
            <button className="group relative px-8 py-4 border-2 border-white text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-white/50 hover:scale-105 hover:-translate-y-1 flex items-center justify-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fadeInLeft">
              <div className="inline-block mb-4">
                <span className="text-[#d90429] text-sm font-bold uppercase tracking-widest">Tentang Kami</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-black text-gray-900 dark:text-white mb-6">
                Menyatukan <span className="text-[#d90429]">Intelektual</span> dan <span className="text-[#ef233c]">Aksi</span>
              </h2>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                Didirikan oleh <strong>Krispol Siregar, S.H.</strong>, SMS lahir dari kesadaran bahwa pemuda harus menjadi motor penggerak perubahan yang berbasis data dan kolaborasi. Beliau membawa visi untuk menciptakan wadah digital yang tidak hanya menyajikan berita, tetapi juga melakukan analisis strategis demi kepentingan publik.
              </p>
              <blockquote className="border-l-4 border-[#d90429] pl-6 py-4 bg-gray-50 dark:bg-gray-800 rounded-r-lg italic text-gray-700 dark:text-gray-300">
                ...
                <div className="text-sm font-bold text-[#d90429] mt-3 not-italic">— Krispol Siregar, S.H., Ketum SMS</div>
              </blockquote>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 overflow-hidden">
                <div className="space-y-4">
                  <div className="bg-[#d90429]/20 text-[#d90429] font-bold text-center py-16 rounded-lg">
                    📸 SMS Activities & Dokumentasi
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-[#d90429]/30 to-red-900/20 rounded-lg h-24 flex items-center justify-center text-center">
                      <span className="text-2xl">🎯</span>
                    </div>
                    <div className="bg-gradient-to-br from-blue-500/20 to-blue-900/20 rounded-lg h-24 flex items-center justify-center text-center">
                      <span className="text-2xl">📊</span>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500/20 to-purple-900/20 rounded-lg h-24 flex items-center justify-center text-center">
                      <span className="text-2xl">🚀</span>
                    </div>
                    <div className="bg-gradient-to-br from-green-500/20 to-green-900/20 rounded-lg h-24 flex items-center justify-center text-center">
                      <span className="text-2xl">💡</span>
                    </div>
                  </div>
                </div>
      ...
      <section id="contact" className="relative py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <a 
                ...
                className={`group animate-slideInUp block transition-all duration-500 ${
                  contact.highlight ? 'md:scale-105 md:row-span-2' : ''
                }`}
                style={{animationDelay: `${0.1 + idx * 0.1}s`}}
              >
                <div className={`relative overflow-hidden rounded-2xl p-8 h-full flex flex-col justify-center text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${
                  contact.highlight 
                    ? 'bg-gradient-to-br from-[#d90429] to-[#ef233c] text-white shadow-lg' 
                    : 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-2 border-gray-200 dark:border-gray-600 hover:border-[#d90429]'
                }`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className={`text-xl font-black mb-2 ${contact.highlight ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      {contact.title}
                    </h3>
                    <p className={`font-bold text-lg ${contact.highlight ? 'text-white/90' : 'text-[#d90429]'}`}>
                      {contact.value}
                    </p>
                  </div>
                </div>
          ...
          {/* CTA untuk Admin/Login */}
          <div className="mt-16 p-8 bg-gradient-to-r from-gray-900 to-black rounded-2xl text-center text-white">
            <h3 className="text-2xl font-black mb-4">Penulis & Admin?</h3>
            <p className="text-gray-300 mb-6">Dapatkan akses penuh untuk mengunggah, mengedit, dan mengelola konten berita terbaru di platform SMS.</p>
            <button className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#d90429] to-[#ef233c] text-white font-bold rounded-xl hover:shadow-2xl hover:shadow-red-500/50 hover:scale-105 transition-all duration-300">
              Masuk Sebagai Admin
